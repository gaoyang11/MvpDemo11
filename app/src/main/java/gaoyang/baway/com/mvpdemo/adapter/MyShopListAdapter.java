...
public class MyShopListAdapter extends RecyclerView.Adapter{
    ...
    class MyItemViewholder extends RecyclerView.ViewHolder{
        ...
        public MyItemViewholder(View itemView) {
            super(itemView);
            tt = itemView.findViewById(R.id.tv_shoplist_title);
            tp =  itemView.findViewById(R.id.tv_shoplist_price);
            i =  itemView.findViewById(R.id.image_left);
            ll =  itemView.findViewById(R.id.linear4);
        }
    }
